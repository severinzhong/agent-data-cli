...
from agent_data_cli.core.manifest import to_cli_flag
from agent_data_cli.core.registry import SourceRegistry


def build_global_help_doc() -> HelpDoc:
    from agent_data_cli.cli.commands import build_global_help_doc as _build_global_help_doc

    return _build_global_help_doc()


def build_command_help_doc(command: str) -> HelpDoc:
    from agent_data_cli.cli.commands import build_command_help_doc as _build_command_help_doc
